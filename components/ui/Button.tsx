    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                primary: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm hover:shadow-md", // Backward compatibility
                danger: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-sm hover:shadow-md", // Backward compatibility
                ...
                gradient: "bg-gradient-to-r from-primary-from to-primary-to text-white hover:shadow-glow-lg shadow-md",
            },
            size: {
                ...
                icon: "h-10 w-10",
                md: "h-10 px-4 py-2", // Backward compatibility
            },
        },
        defaultVariants: {
            variant: "default",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
        ...
        // If it's a motion component, we can use animations
